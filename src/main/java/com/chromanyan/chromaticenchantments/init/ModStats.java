...
public class ModStats {
    ...
    public static void registerStats() {
        Registry.register(BuiltInRegistries.CUSTOM_STAT, ModStats.CONSERVATION_FIREWORKS_SAVED_LOCATION, ModStats.CONSERVATION_FIREWORKS_SAVED_LOCATION);
        Registry.register(BuiltInRegistries.CUSTOM_STAT, ModStats.DROPS_VOIDED_LOCATION, ModStats.DROPS_VOIDED_LOCATION);
